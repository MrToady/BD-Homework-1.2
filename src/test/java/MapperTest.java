...
public class MapperTest {
    ...
    public static final Text INPUT_TEXT4 = new Text("ip29 - - [24/Apr/2011:05:41:30 -0400] \"GET /robots.txt HTTP/1.1\" 404 286 \"-\" \"Baiduspider+(+http://www.baidu.com/search/spider.htm)\"");
    public static final Text INPUT_TEXT5 = new Text("ip28 - - [24/Apr/2011:05:41:56 -0400] \"GET /sun3/ HTTP/1.1\" 304 - \"-\" \"Mozilla/5.0 (compatible; bingbot/2.0; +http://www.bing.com/bingbot.htm)\"");
    ...
    public void testMapWithRegularInput() throws IOException {
        ...
        mapDriver.withInput(new LongWritable(), INPUT_TEXT3);
    ...
    public void TestMapWithStringContainsEmptyBytesValue() throws IOException {
        mapDriver.withInput(new LongWritable(), INPUT_TEXT4);
        mapDriver.withInput(new LongWritable(), INPUT_TEXT5);
